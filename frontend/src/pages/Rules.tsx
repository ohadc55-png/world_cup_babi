    ...
    <div className="relative min-h-dvh pb-24" style={{ background: "var(--color-bg)" }}>
      ...
      <main className="px-5 pt-3 flex flex-col gap-5">
        ...
        >
          ...
          <Tip>
            <strong className="text-white">פנדלים:</strong> בפלייאוף "ניצחון" = מי שעבר הלאה (כולל אחרי פנדלים).
            התוצאה המדויקת מחושבת על זמן רגיל בלבד.
            <br />
            דוגמה: 2(5)–2(4) — מי שניחש "2–2" וגם את הקבוצה שעברה — מקבל את שני המרכיבים.
          </Tip>
        </BigSection>
